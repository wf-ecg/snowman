...
(function (global) {
    ...
    // Needed for: IE8-
    global.DOMException = global.DOMException ||
    function () {
        throw TypeError("Illegal constructor");
    };
    ...
    (function () {
        ...
        function onFrameTimer() {
            ...
            Object.keys(cur_requests).forEach(function (id) {
                ...
                if (!request.element || isVisible(request.element)) request.callback(Date.now());
            });
        }
        ...
        function requestAnimationFrame(callback, element) {
            ...
            if (timeout_handle === - 1) timeout_handle = global.setTimeout(onFrameTimer, 1000 / TARGET_FPS);
            return cb_handle;
        }
...
(function () {
    ...
    function () {
        return '"' + String(this).replace(/[\x00-\x1F"\\\x7F-\uFFFF]/g, function (c) {
            if (Object.prototype.hasOwnProperty.call(ESCAPES, c)) return ESCAPES[c];
            var cc = c.charCodeAt(0);
            if (cc <= 0xFF) return '\\x' + ('00' + cc.toString(16).toUpperCase()).slice(-2);
